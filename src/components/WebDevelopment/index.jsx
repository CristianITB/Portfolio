...
import { ProjectsFrame, ProjectsIntro, ProjectsContainer, ProjectWrapper } from './style'

export const WebDevelopment = () => {
  return (
    <ProjectsFrame>
      <ProjectsIntro>Explore a showcase of my Web Development Projects:</ProjectsIntro>
      <ProjectsContainer>
          <ProjectWrapper>
            <ProjectComponent 
              title={"Minesweeper"} 
